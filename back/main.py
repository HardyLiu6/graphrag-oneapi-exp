...
INPUT_DIR = "/home/sunlight/Projects/graphrag-oneapi-exp/inputs/artifacts"
LANCEDB_URI = "/home/sunlight/Projects/graphrag-oneapi-exp/output/lancedb"
...
async def setup_llm_and_embedder():
    ...
    llm = ChatOpenAI(
        ...
        api_key="sk-wZqb0cY5ONBebr2I9e32A07b22F24fFdA03eB53dC563223d",  # API Key
        model="qwen-plus",  # 本次使用的模型
        api_type=OpenaiApiType.OpenAI,
    )
